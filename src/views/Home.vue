                  ...
                  <div class="tile is-parent is-vertical">
                    ...
                    >
                      <div class="columns is-gapless is-mobile">
                        <div class="column is-narrow is-flex">
                          <div
                            style="align-self:flex-end;padding:0.6rem;width:100%;padding-right:0rem;padding-bottom:0rem"
                          >
                            <p>
                              <span
                        ...
                        <div class="column">
                          <figure class="image">
                            <img :src='require("@/assets/images/pico-home.png")' style="border-radius: 0px 6px 6px 0px"/>
                          </figure>
                        </div>
                      </div>
                    ...
                    >
                      ...
                      <div class="columns is-gapless is-mobile">
                        ...
                        <div class="column">
                          <figure class="image">
                            <img :src='require("@/assets/images/boaonda-home.png")' style="border-radius: 0px 6px 6px 0px;"/>
                          </figure>
                        </div>
                      </div>
                    </article>
                  ...
                  <div class="tile is-parent is-vertical">
                    ...
                    >
                      ...
                      <div class="columns is-gapless is-mobile">
                        ...
                        <div class="column">
                          <figure class="image">
                            <img :src='require("@/assets/images/news-home.png")' style="border-radius: 0px 6px 6px 0px"/>
                          </figure>
                        </div>
                      </div>
                    </article>
                    ...
                    >
                      ...
                      <div class="columns is-gapless is-mobile">
                        <div class="column is-narrow is-flex">
                          <div
                            style="align-self:flex-end;padding:0.6rem;padding-right:0rem;width:100%;padding-bottom:0rem;"
                          >
                            <p>
                              <span
                                class="has-text-white is-uppercase title is-size-7-mobile"
                        ...
                        <div class="column">
                          <figure class="image">
                            <img :src='require("@/assets/images/parceiros-home.png")' style="border-radius: 0px 6px 6px 0px"/>
                          </figure>
                        </div>
                      </div>
                    </article>
                ...
                <div class="tile is-parent">
                  ...
                  >
                    ...
                    <div class="columns is-gapless is-mobile">
                      ...
                      <div class="column">
                        <figure class="image">
                          <img :src='require("@/assets/images/loja-home.png")' style="border-radius: 0px 6px 6px 0px" />
                        </figure>
                      </div>
                    </div>
                  </article>
